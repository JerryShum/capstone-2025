      ...
      <div className="bg-white border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] min-w-[320px] flex flex-col gap-4 font-sans">
         ...
         <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-1">
               ...
               <textarea
                  className="w-full min-h-[150px] text-sm p-3 border-2 border-slate-100 rounded-lg focus:border-purple-500 outline-none transition-colors resize-y font-mono"
