    ...
    <div className="flex w-full min-h-[calc(100vh-4rem)] flex-col items-center justify-center relative overflow-hidden px-4 py-16">
      ...
      <BlurFade delay={0.15} offset={30} className="z-10 w-full max-w-md">
        <div className="relative rounded-[2rem] border border-black/10 dark:border-white/10 bg-white/70 dark:bg-black/40 backdrop-blur-3xl shadow-2xl overflow-hidden p-8 md:p-10">
          {/* Inner top glow */}
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-64 h-40 bg-purple-500/20 blur-3xl rounded-full pointer-events-none" />
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-2">Welcome Back</h1>
            <p className="text-sm text-black/60 dark:text-white/50">Sign in to continue your magical stories</p>
          </div>
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            <Button variant="outline" size="lg" className="w-full rounded-xl border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 text-foreground font-medium transition-all">
              <AtSign className="mr-2 h-4 w-4" /> Continue with Google
            </Button>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-black/50 dark:text-white/40">
            ...
            <Link to="/signup" className="text-purple-600 dark:text-purple-400 font-semibold underline underline-offset-2 hover:text-purple-500 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
