...
const features = [
  {
    ...
    className: "col-span-3 lg:col-span-1 border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300",
  },
  {
    Icon: PenTool,
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden border-b">
        ...
        <div className="container mx-auto relative z-10 max-w-7xl px-4 pt-32 pb-24 text-center">
          ...
          <BlurFade delay={0.1} offset={10}>
            <div className="mx-auto mb-6 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm font-medium text-white shadow-[0_0_2rem_-0.5rem_#fff8] backdrop-blur-xl transition-all hover:bg-white/10 hover:shadow-[0_0_2.5rem_-0.5rem_#fff8]">
              <Sparkles className="mr-2 h-4 w-4 text-blue-400" />
              <span className="bg-linear-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">Introducing Story Weaver 2.0</span>
        ...
        <BlurFade delay={0.4} offset={20}>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link to="/login" className="w-full sm:w-auto relative group">
              ...
              <Button variant="default" size="lg" className="relative h-14 w-full rounded-full bg-white text-black hover:bg-white/90 px-8 text-lg shadow-xl sm:w-auto">
                Start Weaving Free
              </Button>
            </Link>
            <Link to="/about" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="h-14 w-full rounded-full border-white/20 bg-white/5 text-white hover:bg-white/10 px-8 text-lg sm:w-auto backdrop-blur-md">
                How it works
              </Button>
            </Link>
          </div>
      ...
      <div className="mt-40 md:mt-48 relative">
        ...
        <p className="text-white/60 mx-auto max-w-2xl text-center text-lg mb-16">
      ...
      <div className="relative mt-40 py-24 md:mt-48 overflow-hidden rounded-[3rem] border border-white/10 bg-white/5 px-6 shadow-2xl backdrop-blur-3xl">
        <GridPattern
          width={40}
          height={40}
        ...
        <div className="relative z-10 mx-auto max-w-5xl">
          <div className="text-center mb-24">
            ...
            <p className="text-white/60 mx-auto max-w-2xl text-lg md:text-xl">
          ...
          <div className="space-y-32">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              ...
              <div className="relative flex h-40 w-40 md:h-56 md:w-56 shrink-0 items-center justify-center rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_0_40px_-10px_rgba(34,197,94,0.3)]">
                <span className="text-7xl md:text-9xl font-black text-white/5 absolute">1</span>
                <Sparkles className="h-16 w-16 text-green-400 relative z-10" />
                <div className="absolute -inset-4 -z-10 bg-green-500 opacity-20 blur-3xl rounded-full"></div>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-20">
              ...
              <div className="relative flex h-40 w-40 md:h-56 md:w-56 shrink-0 items-center justify-center rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_0_40px_-10px_rgba(234,179,8,0.3)]">
                <span className="text-7xl md:text-9xl font-black text-white/5 absolute">2</span>
                <PenTool className="h-16 w-16 text-yellow-400 relative z-10" />
                <div className="absolute -inset-4 -z-10 bg-yellow-500 opacity-20 blur-3xl rounded-full"></div>
              </div>
              <div className="flex-1 hidden md:block"></div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              ...
              <div className="relative flex h-40 w-40 md:h-56 md:w-56 shrink-0 items-center justify-center rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_0_40px_-10px_rgba(239,68,68,0.3)]">
                <span className="text-7xl md:text-9xl font-black text-white/5 absolute">3</span>
                <Film className="h-16 w-16 text-red-400 relative z-10" />
                <div className="absolute -inset-4 -z-10 bg-red-500 opacity-20 blur-3xl rounded-full"></div>
              </div>
              <div className="flex-1 hidden md:block"></div>
            </div>
          </div>
      ...
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden rounded-lg mt-32 md:mt-48">
        ...
        <Marquee pauseOnHover className="[--duration:30s]">
          {[
            ...
            <div key={i} className="mx-2 flex items-center justify-center rounded-full border border-white/10 bg-white/5 backdrop-blur-md px-6 py-3 shadow-md transition-all hover:bg-white/10 hover:shadow-lg">
        ...
        <Marquee reverse pauseOnHover className="[--duration:35s] mt-4">
          {[
            ...
            <div key={i} className="mx-2 flex items-center justify-center rounded-full border border-white/5 bg-transparent px-6 py-3 transition-all hover:bg-white/5">
              <span className="text-lg font-medium text-white/50">{theme}</span>
            </div>
          ))}
        </Marquee>
      </div>
      ...
      <div className="mt-32 pt-12 text-center md:mt-48 pb-24 relative">
        ...
        <p className="text-white/60 mx-auto max-w-2xl text-center text-xl mb-12">
        ...
        <div className="mt-8 flex justify-center">
          <Link to="/login" className="group relative">
            ...
            <Button variant="default" size="lg" className="relative h-16 rounded-full bg-white text-black hover:bg-white/90 px-10 text-xl font-bold uppercase tracking-wide">
