...
function RouteComponent() {
  return (
    <div className="flex w-full flex-col items-center relative px-4 pt-24 pb-32">
      ...
      {/* Fixed Ambient Glows — fixed positioning prevents navbar/footer clipping */}
      <div className="fixed top-1/4 right-1/4 w-[700px] h-[700px] bg-blue-500/8 dark:bg-blue-500/15 blur-[150px] rounded-full pointer-events-none z-0" />
      <div className="fixed bottom-1/4 left-1/4 w-[600px] h-[600px] bg-pink-500/8 dark:bg-pink-500/15 blur-[130px] rounded-full pointer-events-none z-0" />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-500/5 dark:bg-purple-500/10 blur-[120px] rounded-full pointer-events-none z-0" />
      ...
      <div className="container relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <BlurFade delay={0.3} offset={20}>
          <p className="max-w-2xl text-lg md:text-xl text-black/60 dark:text-white/60 leading-relaxed mb-12">
        ...
        <BlurFade delay={0.4} offset={20}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full mb-24">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="flex flex-col items-center p-6 rounded-2xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-xl hover:bg-black/10 dark:hover:bg-white/10 transition-all"
              >
                <span className="text-4xl font-black bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-1">
                  {stat.value}
                </span>
                <span className="text-sm text-black/50 dark:text-white/50 font-medium">
                  {stat.label}
                </span>
              </div>
            ))}
      ...
      {/* === MISSION SECTION === */}
      <div className="container relative z-10 max-w-5xl mx-auto mb-24">
        <BlurFade delay={0.1} offset={20}>
          <div className="relative rounded-[2.5rem] border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-3xl shadow-2xl overflow-hidden p-10 md:p-16">
            <GridPattern
              width={40}
              height={40}
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-1.5 text-xs font-semibold mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {values.map((v, i) => (
            <BlurFade key={v.title} delay={0.1 + i * 0.08} offset={20}>
              <div className="flex gap-5 items-start p-7 rounded-3xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-xl hover:bg-black/10 dark:hover:bg-white/10 transition-all group">
                <div
                  className={`h-12 w-12 shrink-0 rounded-2xl ${v.bg} flex items-center justify-center ${v.color} group-hover:scale-110 transition-transform duration-300`}
                >
      ...
      <div className="container relative z-10 max-w-3xl mx-auto">
        <BlurFade delay={0.2} offset={20}>
          <div className="relative rounded-[2.5rem] border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-3xl p-12 md:p-16 text-center overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[200px] bg-purple-500/10 blur-[80px] rounded-full pointer-events-none" />
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">
                Ready to Start?
              </h2>
              <p className="text-lg text-black/60 dark:text-white/60 mb-10 max-w-lg mx-auto">
              ...
              <Link to="/login" className="group relative inline-block">
                ...
                <Button
                  size="lg"
                  className="relative h-14 rounded-full bg-black text-white dark:bg-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 px-12 text-lg shadow-xl font-bold"
                >
                  Start Weaving Free
                </Button>
              </Link>
